...
WebUI.click(findTestObject('Page_OrangeHRM_AddCurrency/Page_OrangeHRM/span_Actions_oxd-checkbox-input oxd-checkbox-input--active --label-right oxd-checkbox-input'))

WebUI.click(findTestObject('Page_OrangeHRM_AddCurrency/Page_OrangeHRM/button_Afghanistan Afghani_oxd-icon-button oxd-table-cell-action-space'))
