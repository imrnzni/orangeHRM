...
WebUI.click(findTestObject('Page_OrangeHRM_AddCurrency/Page_OrangeHRM/div_AED - Utd. Arab Emir. Dirham'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM_AddCurrency/Page_OrangeHRM/input_Minimum Salary_oxd-input oxd-input--focus'), 
    '110000')

WebUI.setText(findTestObject('Page_OrangeHRM_AddCurrency/Page_OrangeHRM/input_Maximum Salary_oxd-input oxd-input--f_c30d90'), 
    '147000')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM_AddCurrency/Page_OrangeHRM/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM_AddCurrency/Page_OrangeHRM/div_SuccessSuccessfully Saved'), 
    0)
