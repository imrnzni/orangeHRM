...
WebUI.uploadFile(findTestObject('Page_OrangeHRM_AddEmployee/Page_OrangeHRM/i_Add Employee_oxd-icon bi-plus'), 'C:\\Users\\Dell\\Downloads\\png-5mb-1.png')
...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM_AddEmployee/Page_OrangeHRM/span_Attachment Size Exceeded'), 0)
