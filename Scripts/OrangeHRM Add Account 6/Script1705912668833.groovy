...
WebUI.setText(findTestObject('Object Repository/OrangeHRM Add Account/Page_OrangeHRM/input'), 'Anthony Nolan')

WebUI.click(findTestObject('OrangeHRM Add Account/Page_OrangeHRM/div_Anthony  Nolan'))
...
WebUI.click(findTestObject('OrangeHRM Add Account/Page_OrangeHRM/span_Your password must contain minimum 1 number'))
