...
WebUI.setText(findTestObject('Page_OrangeHRM_AddEmployee/Page_OrangeHRM/input_Employee Full Name_firstName'), 'Abu')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM_AddEmployee/Page_OrangeHRM/div_SuccessSuccessfully Saved'), 
    0)
